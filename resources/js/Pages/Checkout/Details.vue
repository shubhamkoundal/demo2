    ...
    <div class="bg-white p-4 rounded-md shadow overflow-x-auto print:shadow-none print:pt-0">
      ...
      <div class="block sm:flex justify-between print:flex">
        <div class="w-full sm:w-1/2 leading-snug mb-6 sm:mb-0">
          ...
          <div v-if="checkout && checkout.customer && checkout.customer.name">{{ $t('Customer') }}: {{ checkout.customer.name }}</div>
        </div>
        ...
        <!--<div class="text-left w-full sm:w-1/2 leading-snug">-->
        <!--   <div class="text-sm font-bold">{{ $t('Customer') }}:</div>-->
        <!--      <div v-if="checkout && checkout.customer">-->
        <!--     <div>{{ checkout.customer.name }}</div>-->
        <!--   <div v-if="checkout.customer.phone">{{ checkout.customer.phone }}</div>-->
        <!--    </div>-->
        <!--  </div>-->
