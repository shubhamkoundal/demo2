  ...
  <admin-layout :title="$t('category')">
    <div class="px-4 md:px-0">
      <tec-section-title class="-mx-4 md:mx-0 mb-6">
        ...
        <template #description>{{ $t('Pldcccdcdcdease review the data in the table below') }}</template>
      </tec-section-title>
  ...
  watch: {
    form: {
      handler: throttle(function () {
        ...
        this.$inertia.visit(this.route('reports.categories', Object.keys(query).length ? query : { remember: 'forget' }), {
          onFinish: () => {
